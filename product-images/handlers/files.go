...
import (
	...
	"github.com/kishor82/go-microservices/product-images/files"
)
...
func (f *Files) UploadMultipart(rw http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		http.Error(rw, "[PARSE ERROR] Expected multipart form data", http.StatusBadRequest)
		return
	}
...
func (f *Files) invalidURI(uri string, rw http.ResponseWriter) {
	...
	http.Error(
		rw,
		"Invalid file path should be in the format: /[id]/[filepath]",
